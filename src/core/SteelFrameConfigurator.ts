...
function pendingGuide(issues: SteelFrameSpecificationIssue[]): string {
  ...
  return `<div class="sf-stage"><span>ETAPA ATUAL</span><strong>${stage} · ${floorLabel(activeFloor)}</strong></div>
    ...
    <div class="sf-color-legend"><i></i><span>Cada cor identifica um sistema escolhido. A hachura diagonal sobre a cor e a faixa turquesa no topo identificam uma parede com isolamento térmico/acústico aplicado. Marcos de portas/janelas e o topo das paredes não entram na seleção.</span></div>
