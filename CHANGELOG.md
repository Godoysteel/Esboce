...
- Corrigido: a face de uma parede sem acabamento escolhido aparecia num tom cinza-azulado em vez de branca, por causa da mistura das luzes coloridas da cena (céu, chão e preenchimento) incidindo sobre o material. Agora essa face usa uma cor sólida, sempre branca, imune à iluminação — acabamentos reais (cerâmica, textura, Steel Frame) continuam recebendo luz normalmente. Ver DEC-174.
