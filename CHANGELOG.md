...
- Corrigido (achado com a ferramenta Marcador acima): quando um espigão atravessava um telhado vizinho menor e cruzava a cumeeira DELE, o corte que interrompe o espigão ali (ver DEC-206) apagava também um trecho final que já tinha saído da pegada do vizinho e devia continuar visível — acontecia quando a cumeeira do vizinho fica no meio da própria pegada dele, não perto da borda. Agora o corte fica limitado à pegada real do vizinho. Ver DEC-208.
