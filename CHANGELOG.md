...
- Melhorado (parcial): quando a parede de oitão do vizinho fica muito perto da própria cumeeira, o corte acima (mesmo já limitado pela DEC-211) ainda podia apagar quase toda a água que sobrava — agora nunca remove mais que metade da distância restante até a cumeeira. Reduz o problema pela metade nesse caso apertado; a correção definitiva (geometria real também na água) fica para depois. Ver DEC-212.
