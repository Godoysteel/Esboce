...
- Baseline atual validada com **117 testes automatizados**.
...
- O arraste de cômodos isolados e de fachadas de glazing passou a usar prévia incremental: durante o movimento, somente os objetos 3D envolvidos mudam de posição; o documento do projeto é atualizado uma única vez ao soltar. Isso elimina reconstruções completas da cena a cada evento do ponteiro e reduz fortemente o atraso em projetos maiores.
